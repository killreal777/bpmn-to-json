...
Resolve script paths relative to this skill directory. When installed as a Claude Code plugin or Qwen Code extension from the repository root, the plugin root is the directory that contains `skills/`.
