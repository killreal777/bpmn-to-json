...
const skillConverterDir = resolve(repoRoot, 'skills/bpmn-optimized-reader/assets/bpmn-to-json');
...
console.log(`Built BPMN optimized reader converter into ${skillConverterDir}`);
